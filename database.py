    ...
    async with async_session() as session:
        ...
        places = [
            ...
            Place(name="Công viên Thống Nhất", name_ja="統一公園",
                  ...
                  is_indoor=False, has_japanese_support=False, rating=4.5,
            ...
            Place(name="Công viên Hồ Tây", name_ja="西湖公園",
                  ...
                  lat=21.0544, lng=105.8194, category=PlaceCategory.park,
                  is_indoor=False, has_japanese_support=False, rating=4.7,
            ...
            Place(name="Công viên Nghĩa Đô", name_ja="ギアド公園",
                  ...
                  is_indoor=False, has_japanese_support=True, rating=4.2,
            ...
            Place(name="Vườn hoa Lý Thái Tổ", name_ja="リータイトー広場",
                  ...
                  is_indoor=False, has_japanese_support=False, rating=4.0,
            ...
            Place(name="Công viên Thủ Lệ", name_ja="トゥーレー動物園公園",
                  ...
                  is_indoor=False, has_japanese_support=False, rating=4.3,
            ...
            Place(name="California Fitness Hà Nội", name_ja="カリフォルニアフィットネス",
                  ...
                  is_indoor=True, has_japanese_support=True, rating=4.6,
            ...
            Place(name="Gym 24h Đống Đa", name_ja="24時間ジム ドンダー",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=4.1,
            ...
            Place(name="Elite Fitness Ba Đình", name_ja="エリートフィットネス バーディン",
                  ...
                  is_indoor=True, has_japanese_support=True, rating=4.8,
            ...
            Place(name="Fit24 Cầu Giấy", name_ja="フィット24 カウザイ",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=4.3,
                  opening_hours={"T2-CN": "05:00-23:00"}, phone="024-3756-8901"),
            Place(name="Zen Yoga & Gym Tây Hồ", name_ja="ゼンヨガ＆ジム タイホー",
                  address="Tây Hồ, Hà Nội",
                  lat=21.0612, lng=105.8156, category=PlaceCategory.gym,
                  is_indoor=True, has_japanese_support=True, rating=4.5,
            ...
            Place(name="IronWolf Gym Hai Bà Trưng", name_ja="アイアンウルフ ジム",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=4.0,
            ...
            Place(name="Lotte Fitness Center", name_ja="ロッテフィットネスセンター",
                  ...
                  is_indoor=True, has_japanese_support=True, rating=4.9,
                  opening_hours={"T2-T6": "06:00-22:00", "T7-CN": "07:00-21:00"},
                  phone="024-3333-6789"),
            # POOL
            Place(name="Bể bơi Mỹ Đình", name_ja="ミーディン水泳プール",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=4.4,
            ...
            Place(name="Hồ bơi Hoàng Mai", name_ja="ホアンマイ室内プール",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=3.9,
            ...
            Place(name="Sân cầu lông Nguyễn Tri Phương", name_ja="グエントリフオン バドミントン",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=4.2,
            ...
            Place(name="Sân cầu lông Bạch Mai", name_ja="バクマイ バドミントン",
                  ...
                  is_indoor=True, has_japanese_support=False, rating=3.8,
